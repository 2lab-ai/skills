...
**Source:** https://github.com/steipete/agent-scripts/tree/main/skills/create-cli (adopted 2026-05-16)
**적용 대상:** soma / p9 / 일반 도구 CLI 설계. macOS-specific 가정 없음 (linux WSL OK).
...
- Read `references/cli-guidelines.md` (이 스킬 디렉토리에 포함) and apply it as the default rubric.
...
- p9/soma 컨텍스트: `~/2lab.ai/soma/src/bin/`의 기존 CLI 스타일 (clipanion 등)을 먼저 확인.
